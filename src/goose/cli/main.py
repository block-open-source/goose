...
def session_start(name: Optional[str], profile: str, log_level: str, safe_mode: bool, plan: Optional[str] = None) -> None:
    ...
    if plan:
        ...
        _plan = None
    session = Session(name=name, profile=profile, plan=_plan, log_level=log_level, safe_mode=safe_mode)
    session.run()
